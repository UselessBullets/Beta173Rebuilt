...
public class MinecraftServer implements Runnable, ConsoleInputSource
{
    ...
    public static HashMap ironTimers;
    ...
    public MinecraftServer() {
        ...
        this.consoleInput = Collections.synchronizedList(new ArrayList<Object>());
        this.trackers = new EntityTracker[2];
        new MinecraftServer_1(this);
    }
    
    private boolean initServer() {
        this.commands = new ConsoleCommands(this);
        final MinecraftServer_HandleCommandsThread minecraftServer_HandleCommandsThread = new MinecraftServer_HandleCommandsThread(this);
        minecraftServer_HandleCommandsThread.setDaemon(true);
        minecraftServer_HandleCommandsThread.start();
    ...
    private void loadLevel(final LevelStorageSource storageSource, final String name, final long seed) {
        if (storageSource.requiresConversion(name)) {
            ...
            storageSource.convertLevel(name, new MinecraftServer_ConversionProgressListener(this));
        }
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            new MinecraftServer_ServerThread("Server thread", minecraftServer).start();
        }
        catch (final Exception thrown) {
