...
public class ServerPlayer extends Player implements ContainerListener
{
    ...
    public List chunksToSend;
    public Set seenChunks;
    ...
    @Override
    public void startsCrafting(final int x, final int y, final int z) {
    ...
    public void refreshContainer(final AbstractContainerMenu container, final List items) {
