...
public class ServerConnection
{
    ...
    public ServerConnection(final MinecraftServer server, final InetAddress address, final int port) {
        this.running = false;
        ...
        this.running = true;
        (this.listenThread = new ServerConnection_ListenThread(this, "Listen thread", server)).start();
    }
