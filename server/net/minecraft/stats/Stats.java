...
public class Stats
{
    ...
    static {
        ...
        Stats.jump = new GeneralStat(2010, I18n.get("stat.jump")).setAwardLocallyOnly().postConstruct();
        Stats.drop = new GeneralStat(2011, I18n.get("stat.drop")).setAwardLocallyOnly().postConstruct();
