...
public class Snowball extends Entity
{
    ...
    public Snowball(final Level level, final Mob mob) {
        ...
        final float n = 0.4f;
        this.xd = -Mth.sin(this.yRot / 180.0f * 3.1415927f) * Mth.cos(this.xRot / 180.0f * 3.1415927f) * n;
        this.zd = Mth.cos(this.yRot / 180.0f * 3.1415927f) * Mth.cos(this.xRot / 180.0f * 3.1415927f) * n;
        this.yd = -Mth.sin(this.xRot / 180.0f * 3.1415927f) * n;
            ...
            for (int i = 0; i < entities.size(); ++i) {
                ...
                if (entity.isPickable()) {
                    if (entity != this.owner || this.flightTime >= 5) {
                        final float n2 = 0.3f;
                        final HitResult clip2 = entity.bb.grow(n2, n2, n2).clip(temp, b);
                        if (clip2 != null) {
