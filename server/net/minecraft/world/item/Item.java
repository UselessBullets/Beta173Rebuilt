...
public class Item
{
    ...
    public static Item shovel_item;
    ...
    static {
        ...
        Item.shovel_item = new ShovelItem(0, Item_Tier.IRON).setIcon(2, 5).setDescriptionId("shovelIron");
        ...
        Item.swordIron = new WeaponItem(11, Item_Tier.IRON).setIcon(2, 4).setDescriptionId("swordIron");
