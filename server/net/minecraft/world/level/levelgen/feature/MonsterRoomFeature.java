...
public class MonsterRoomFeature extends Feature
{
    ...
    public boolean place(final Level level, final Random random, final int x, final int y, final int z) {
                ...
                if (level.isEmptyTile(x2, y, z2)) {
                    ...
                    if (n8 == 1) {
                        ...
                        for (int n9 = 0; n9 < 8; ++n9) {
                            final ItemInstance a = this.a(random);
                            if (a != null) {
                                chestTileEntity.setItem(random.nextInt(chestTileEntity.getContainerSize()), a);
                            }
                        }
                        break;
                    }
        ...
        ((MobSpawnerTileEntity)level.getTileEntity(x, y, z)).setEntityId(this.b(random));
        return true;
    }
    
    private ItemInstance a(final Random random) {
