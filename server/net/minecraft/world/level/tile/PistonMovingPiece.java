...
public class PistonMovingPiece extends EntityTile
{
    ...
    public static TileEntity newMovingPieceEntity(final int block, final int data, final int facing, final boolean extending, final boolean isSource) {
        return new PistonPieceEntity(block, data, facing, extending, isSource);
    }
