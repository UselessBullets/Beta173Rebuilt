...
public class StreamState
{
    ...
    public void init(final int integer) {
    ...
    void body_expand(final int integer) {
        if (this.body_storage <= this.body_fill + integer) {
            this.body_storage += integer + 1024;
    ...
    void lacing_expand(final int integer) {
        if (this.lacing_storage <= this.lacing_fill + integer) {
            this.lacing_storage += integer + 32;
    ...
    public int packetin(final Packet packet) {
        final int integer = packet.bytes / 255 + 1;
        ...
        final int n = this.lacing_fill + i;
