...
public class SyncState
{
    ...
    public int buffer(final int integer) {
        if (this.returned != 0) {
        ...
        if (integer > this.storage - this.fill) {
            final int storage = integer + this.fill + 4096;
            if (this.data != null) {
    ...
    public int wrote(final int integer) {
        if (this.fill + integer > this.storage) {
            return -1;
        }
        this.fill += integer;
        return 0;
