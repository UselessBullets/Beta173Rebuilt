...
public class MinecraftApplet extends Applet
{
    ...
    public void init() {
        ...
        if (this.getDocumentBase().getPort() > 0) {
            this.minecraft.serverDomain = this.minecraft.serverDomain + ":" + this.getDocumentBase().getPort();
        }
    ...
    @Override
    public void start() {
        if (this.minecraft != null) this.minecraft.pause = false;
    }
    
    @Override
    public void stop() {
        if (this.minecraft != null) this.minecraft.pause = true;
    }
