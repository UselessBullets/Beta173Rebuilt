...
public class OutOfMemoryScreen extends Screen
{
    ...
    public void render(final int xm, final int ym, final float partialTick) {
        ...
        this.drawString(this.font, "memory. If you are playing in a web browser, try", this.width / 2 - 140, this.height / 4 - 60 + 60 + 36, 0xa0a0a0);
        this.drawString(this.font, "downloading the game and playing it offline.", this.width / 2 - 140, this.height / 4 - 60 + 60 + 45, 0xa0a0a0);
        this.drawString(this.font, "To prevent level corruption, the current game has quit.", this.width / 2 - 140, this.height / 4 - 60 + 60 + 63, 0xa0a0a0);
        this.drawString(this.font, "Please restart the game.", this.width / 2 - 140, this.height / 4 - 60 + 60 + 81, 0xa0a0a0);
