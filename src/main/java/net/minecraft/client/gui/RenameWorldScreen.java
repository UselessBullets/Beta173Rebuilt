...
public class RenameWorldScreen extends Screen
{
    ...
    public void init() {
        ...
        this.buttons.clear();
        this.buttons.add(new Button(0, this.width / 2 - 100, this.height / 4 + 96 + 12, language.getElement("selectWorld.renameButton")));
        ...
        LevelData levelData = levelSource.getDataTagFor(this.levelId);
        String currentName = levelData.getLevelName();

        this.nameEdit = new EditBox(this, this.font, this.width / 2 - 100, 60, 200, 20, currentName);
    ...
    protected void buttonClicked(final Button button) {
        ...
        if (button.id == 1) {
            ...
            LevelStorageSource levelSource = this.minecraft.getLevelSource();
            levelSource.renameLevel(this.levelId, this.nameEdit.getValue().trim());
    ...
    public void render(final int xm, final int ym, final float a) {
        ...
        this.drawCenteredString(this.font, language.getElement("selectWorld.renameTitle"), this.width / 2, this.height / 4 - 60 + 20, 0xffffff);
