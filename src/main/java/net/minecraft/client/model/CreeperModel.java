...
public class CreeperModel extends Model
{
    ...
    public CreeperModel(final float g) {
        ...
        this.head.setPos(0.0f, (float)n, 0.0f);
        (this.hair = new Cube(32, 0)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8, g + 0.5f);
        this.hair.setPos(0.0f, (float)n, 0.0f);
        (this.body = new Cube(16, 16)).addBox(-4.0f, 0.0f, -2.0f, 8, 12, 4, g);
        this.body.setPos(0.0f, (float)n, 0.0f);
        (this.leg0 = new Cube(0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4, 6, 4, g);
        this.leg0.setPos(-2.0f, (float)(12 + n), 4.0f);
        (this.leg1 = new Cube(0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4, 6, 4, g);
        this.leg1.setPos(2.0f, (float)(12 + n), 4.0f);
        (this.leg2 = new Cube(0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4, 6, 4, g);
        this.leg2.setPos(-2.0f, (float)(12 + n), -4.0f);
        (this.leg3 = new Cube(0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4, 6, 4, g);
        this.leg3.setPos(2.0f, (float)(12 + n), -4.0f);
    }
