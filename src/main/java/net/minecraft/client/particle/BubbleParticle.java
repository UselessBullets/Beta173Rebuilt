...
public class BubbleParticle extends Particle
{
    public BubbleParticle(final Level level, final double x, final double y, final double z, final double xa, final double ya, final double za) {
        ...
        this.xd = xa * 0.20000000298023224 + (float)(Math.random() * 2.0 - 1.0) * 0.02f;
        this.yd = ya * 0.20000000298023224 + (float)(Math.random() * 2.0 - 1.0) * 0.02f;
        this.zd = za * 0.20000000298023224 + (float)(Math.random() * 2.0 - 1.0) * 0.02f;
