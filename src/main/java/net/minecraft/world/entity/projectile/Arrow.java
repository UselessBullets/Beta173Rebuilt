...
public class Arrow extends Entity
{
    ...
    public void tick() {
        ...
        if (this.xRotO == 0.0f && this.yRotO == 0.0f) {
            ...
            final float n = (float)(Math.atan2(this.xd, this.zd) * 180.0 / Math.PI);
            this.yRot = n;
            this.yRotO = n;
            final float n2 = (float)(Math.atan2(this.yd, sqrt) * 180.0 / Math.PI);
            this.xRot = n2;
            this.xRotO = n2;
        }
        ...
        if (!this.inGround) {
            ...
            this.xRot = (float)(Math.atan2(this.yd, sqrt3) * 180.0 / Math.PI);
