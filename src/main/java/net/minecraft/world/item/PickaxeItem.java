...
public class PickaxeItem extends DiggerItem
{
    ...
    public boolean canDestroySpecial(final Tile tile) {
        ...
        return tile.material == Material.stone || tile.material == Material.metal;
    }
    
    static {
        PickaxeItem.diggables = new Tile[] { Tile.stoneBrick, Tile.stoneSlab, Tile.stoneSlabHalf, Tile.rock, Tile.sandStone, Tile.mossStone, Tile.ironOre, Tile.ironBlock, Tile.coalOre, Tile.goldBlock, Tile.goldOre, Tile.emeraldOre, Tile.emeraldBlock, Tile.ice, Tile.hellRock, Tile.lapisOre, Tile.lapisBlock };
    }
}
