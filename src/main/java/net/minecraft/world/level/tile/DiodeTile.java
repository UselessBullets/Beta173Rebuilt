...
{
    public static final int DIRECTION_MASK = 0b11; // Useless - possibly a forward port, DiodeTile starts extending DirectionalTile in the future and this mask is part of DirectionalTile
    public static final int DELAY_MASK = 0b1100;
