...
public class CommandThread extends SimpleThread
{
    ...
    protected void message(final String string, final int integer) {
        this.logger.message(string, integer);
    }
    
    protected void importantMessage(final String string, final int integer) {
        this.logger.importantMessage(string, integer);
    }
    
    protected boolean errorCheck(final boolean boolean1, final String string) {
        return this.logger.errorCheck(boolean1, this.className, string, 0);
    }
    
    protected void errorMessage(final String string, final int integer) {
        this.logger.errorMessage(this.className, string, integer);
    }
}
