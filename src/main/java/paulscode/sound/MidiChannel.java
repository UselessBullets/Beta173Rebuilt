...
public class MidiChannel implements MetaEventListener
{
    ...
    public MidiChannel(final boolean boolean1, final String string2, final String string3) {
        this.sequencer = null;
        ...
        this.setLooping(boolean1);
        this.init();
        this.loading(true, false);
    }
    
    public MidiChannel(final boolean boolean1, final String string2, final URL uRL, final String string4) {
        this.sequencer = null;
        this.synthesizer = null;
        this.synthDevice = null;
        this.sequence = null;
        ...
        this.loading(true, true);
        this.logger = SoundSystemConfig.getLogger();
        this.filenameURL(true, new FilenameURL(uRL, string4));
        this.sourcename(true, string2);
        this.setLooping(boolean1);
        this.init();
        this.loading(true, false);
    ...
    public MidiChannel(final boolean boolean1, final String string, final FilenameURL filenameURL) {
        this.sequencer = null;
        this.synthesizer = null;
        this.synthDevice = null;
        this.sequence = null;
    ...
    public void play() {
        if (!this.loading()) {
            ...
            try {
                ...
                SoundSystem.setException(new SoundSystemException(exception.getMessage()));
            }
        }
    }
    ...
    public void switchSource(final boolean boolean1, final String string2, final String string3) {
        this.loading(true, true);
        this.filenameURL(true, new FilenameURL(string3));
        this.sourcename(true, string2);
        this.setLooping(boolean1);
    ...
    public void switchSource(final boolean boolean1, final String string2, final URL uRL, final String string4) {
        this.loading(true, true);
        this.filenameURL(true, new FilenameURL(uRL, string4));
        this.sourcename(true, string2);
        this.setLooping(boolean1);
    ...
    public void switchSource(final boolean boolean1, final String string, final FilenameURL filenameURL) {
        this.loading(true, true);
        this.filenameURL(true, filenameURL);
        this.sourcename(true, string);
        this.setLooping(boolean1);
    ...
    private synchronized boolean toLoop(final boolean boolean1, final boolean boolean2) {
        if (boolean1) {
            this.toLoop = boolean2;
        }
        return this.toLoop;
    }
    ...
    private synchronized boolean loading(final boolean boolean1, final boolean boolean2) {
        if (boolean1) {
            this.loading = boolean2;
        }
        return this.loading;
    }
    
    public void setSourcename(final String string) {
        this.sourcename(true, string);
    }
    ...
    private synchronized String sourcename(final boolean boolean1, final String string) {
        if (boolean1) {
    ...
    private synchronized FilenameURL filenameURL(final boolean boolean1, final FilenameURL filenameURL) {
        if (boolean1) {
    ...
    private void setSequence(final URL uRL) {
        ...
        catch (final InvalidMidiDataException exception2) {
        ...
        if (this.sequence == null) {
            ...
            catch (final InvalidMidiDataException exception3) {
    ...
    private void getSynthesizer() {
        ...
        if (this.sequencer instanceof Synthesizer) {
            ...
            if (this.synthesizer == null) {
                ...
                catch (final MidiUnavailableException ex3) {
                ...
                catch (final MidiUnavailableException ex4) {
    ...
    private Sequencer openSequencer(final String string) {
        final Sequencer sequencer = (Sequencer)this.openMidiDevice(string);
        if (sequencer == null) {
            return null;
        }
        try {
    ...
    private MidiDevice openMidiDevice(final String string) {
        ...
        for (int i = 0; i < midiDeviceInfo.length; ++i) {
            ...
            if (midiDevice != null && midiDeviceInfo[i].getName().contains(string)) {
    ...
    protected boolean errorCheck(final boolean boolean1, final String string) {
        return this.logger.errorCheck(boolean1, "MidiChannel", string, 0);
    }
